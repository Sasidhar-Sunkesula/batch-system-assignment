import BadgeComponent from "./group-component";
...
export function Main() {
  return (
    <main className="w-full h-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px]">
      ...
      <div className="absolute top-[4689.7px] left-[50px] w-[327px] h-[237.3px] flex items-center justify-center">
        <img
      ...
      <img
        className="absolute bg-slate-500 top-[0px] left-[0px] w-[1440px] h-[8220px] object-cover mix-blend-soft-light -z-10"
        alt=""
