...
const SeventhPage: NextPage<SeventhPageType> = ({ className = "" }) => {
  return (
    ...
    >
      ...
      <div className="w-[536px] flex flex-col items-start justify-start pt-16 px-0 pb-0 box-border max-w-full ml-[-547px] text-lg">
      ...
      <div className="h-[719.5px] w-[566.5px] absolute !m-[0] bottom-[-403.5px] left-[-175px]">
        <img
          ...
          src="/group-35905.svg"
        />
        <button className="cursor-pointer [border:none] pt-3.5 pb-[14.4px] pr-[21px] pl-[22px] bg-white absolute top-[100px] mq1050:top-[300px] left-[252px] rounded flex flex-row items-start justify-start gap-[12px] z-[1]">
          <div className="h-[60px] w-52 relative rounded bg-white hidden" />
          <div className="flex flex-col items-start justify-start pt-0.5 px-0 pb-0">
            <div className="relative text-lg leading-[28px] capitalize font-medium font-clash-display text-black text-left inline-block min-w-[127px] z-[1]">
              download app
            </div>
          </div>
          <img
      ...
      <div className="h-[731.9px] w-[676px] absolute !m-[0] top-[-248px] right-[-175px]">
        ...
        <div className="absolute top-[272px] left-[0px] w-[591px] h-[459.9px]">
          <img
            className="absolute top-[75px] left-[143px] w-[378.2px] h-[367.5px] object-contain"
            loading="lazy"
            alt=""
