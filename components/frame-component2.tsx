...
const FrameComponent2: NextPage<FrameComponent2Type> = ({ className = "" }) => {
  return (
    ...
    >
      ...
      <p className="m-0 self-stretch mq1050:text-center relative leading-[28px] capitalize font-medium text-gray-500 z-[8]">
      ...
      <div className="w-[374px] flex flex-row justify-between items-center max-w-full gap-[20px] mq450:flex-wrap">
        <button className="cursor-pointer [border:none] py-4 px-[23px] bg-black rounded flex flex-row items-start justify-start gap-[6px] z-[8]">
          ...
          <div className="relative text-lg leading-[28px] capitalize font-medium font-clash-display text-white text-left inline-block min-w-[104px] whitespace-nowrap z-[1]">
            get started
          </div>
        ...
        <div className="flex items-center gap-x-2 justify-center px-0 pb-0">
          <img className=" w-[29px] h-[29px] z-[8]" alt="" src="/group-3.svg" />
          <div className="leading-[28px] capitalize font-medium inline-block min-w-[111px] z-[8]">
            watch video
          </div>
        </div>
      </div>
      <img src="badge.png" className="w-[540px] mq1050:w-full" alt="badge" />
    </div>
  );
};
