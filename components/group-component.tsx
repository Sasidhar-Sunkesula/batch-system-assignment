  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[9.8px] left-[208.3px] w-[297.5px] h-[302.6px]">
        ...
        <a className="[text-decoration:none] absolute top-[263.4px] left-[201.5px] text-2xs-5 leading-[18.3px] capitalize font-medium text-[inherit] inline-block min-w-[50px] z-[6]">
          free trial
        </a>
      </div>
